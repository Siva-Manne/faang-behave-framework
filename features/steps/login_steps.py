...
def step_impl(context, password):
    ...
    # TODO Day 8: 
    context.login_page.login(context.valid_user, password)
    pass
...
def step_impl(context):
    ...
    # TODO Day 8: 
    assert "Welcome" in context.dashboard_page.welcome_text()
    pass
...
def step_impl(context):
    ...
    # TODO Day 8: 
    assert context.login_page.error_message() is not None
    pass
...
def step_impl(context):
    ...
    # TODO Day 8: 
    assert context.login_page.is_visible()
    pass
...
def step_impl(context):
    ...
    # TODO Day 8: 
    assert not context.dashboard_page.is_visible()
    pass
...
def step_impl(context):
    ...
    # TODO Day 8: 
    assert context.dashboard_page.is_visible()
    assert context.dashboard_page.welcome_text() == "Products"
    pass